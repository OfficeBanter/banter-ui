...
interface LoadingContextParams {
  isLoading: boolean;
  setLoading: (name: string) => (value: boolean) => void;
}
const LoadingContext = createContext<LoadingContextParams | null>(null);

export function LoadingProvider({ children }) {
  const [loading, setLoadingInternal] = useState({});
...
export function useLoading({ name }: UseLoadingProps) {
